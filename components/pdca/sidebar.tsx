...
import { Database, Layers, LayoutDashboard, TrendingUp, UploadCloud, Wifi, WifiOff } from "lucide-react";
...
export function Sidebar({ pdcaCount, subactionCount, doneCount, completion, localMode }: SidebarProps) {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 hidden w-72 border-r border-[#1E7FD5]/15 bg-[#08192E] lg:flex lg:flex-col z-30">

      {/* Logo */}
      <div className="flex items-center gap-3 border-b border-[#1E7FD5]/15 px-6 py-5">
